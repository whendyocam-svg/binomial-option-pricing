#NOMBRE DEL CÓDIGO: MODELO_BINOMIAL
#MÉTODO BLACK_SCHOLES CON PRUEBA DE PARIDAD PUT-CALL.
#MÉTODO BINOMIAL, OPCIÓN:AMERICANA Y EUROPEA; PUT O CALL; GRÁFICA, PARIDAD PUT-CALL PARA EUROPEAS
#EU USUARIO PUEDE INGRESAR EL VALOR DE SIGMA O U Y D
